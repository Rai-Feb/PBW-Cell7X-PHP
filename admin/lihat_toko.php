...
if ($sort === 'harga_asc') $order_by = "harga_min ASC";
elseif ($sort === 'harga_desc') $order_by = "harga_min DESC";
elseif ($sort === 'nama_asc') $order_by = "nama_barang ASC"; 
...
<head>
    ...
    <title>Lihat Toko - 7CellX Admin</title>
    ...
    <style>
        :root {
            ...
            --glow-shadow: 0 15px 35px rgba(156, 39, 176, 0.2); --card-shadow: 0 8px 25px rgba(0, 0, 0, 0.04);
        }
        * { font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        .btn-white-nav:hover { transform: translateY(-2px); color: var(--brand-pink); }
        ...
        .btn-primary-custom { background: var(--brand-gradient); color: white; border: none; padding: 12px 24px; border-radius: 14px; font-weight: 700; transition: all 0.3s; text-decoration: none; display: inline-flex; align-items: center; justify-content: center; gap: 8px; font-size: 0.95rem; }
        .btn-primary-custom:hover { transform: translateY(-2px); box-shadow: var(--glow-shadow); color: white; }
        ...
        .custom-modal-box { background: var(--bg-card); width: 90%; max-width: 500px; border-radius: 24px; padding: 30px; box-shadow: 0 20px 40px rgba(0,0,0,0.1); transform: translateY(20px); animation: modalFadeIn 0.3s forwards; text-align: left; }
...
<body>
        ...
        <div class="container d-lg-flex px-4">
            ...
            <div class="collapse navbar-collapse nav-zone-center justify-content-center" id="navbarNav">
                <ul class="navbar-nav align-items-center gap-2 mt-3 mt-lg-0">
                    <li class="nav-item"><a class="nav-link d-flex align-items-center gap-2" href="index.php"><i class="bi bi-speedometer2"></i> Dashboard</a></li>
                    <li class="nav-item"><a class="nav-link d-flex align-items-center gap-2" href="produk.php"><i class="bi bi-box-seam"></i> Produk</a></li>
                    <li class="nav-item"><a class="nav-link d-flex align-items-center gap-2" href="pesanan.php"><i class="bi bi-receipt"></i> Pesanan</a></li>
                    <li class="nav-item"><a class="nav-link d-flex align-items-center gap-2" href="chat.php"><i class="bi bi-chat-dots"></i> Chat</a></li>
                    <li class="nav-item"><a class="nav-link active d-flex align-items-center gap-2" href="lihat_toko.php"><i class="bi bi-shop"></i> Lihat Toko</a></li>
                </ul>
            </div>

            <div class="collapse navbar-collapse nav-zone-right justify-content-end" id="navbarNavRight" style="flex: 1;">
                <div class="dropdown">
                    <button class="btn-white-nav dropdown-toggle" type="button" data-bs-toggle="dropdown">
                        ...
                        <?php endif; ?>
                        <span class="text-gradient"><?= htmlspecialchars($active_user['username'] ?? 'Admin') ?></span>
                    </button>
    ...
    <div class="container flex-grow-1 mb-5">
        ...
        <div class="alert alert-info border-0 text-center rounded-4 py-3 mt-4 mb-0" style="background: rgba(156, 39, 176, 0.05); border: 1px dashed var(--brand-purple) !important;">
            <i class="bi bi-eye-fill me-2" style="color: var(--brand-purple);"></i>
            <span class="fw-bold text-dark">Mode Admin:</span> Anda sedang melihat tampilan toko sebagai Pengawas. Fitur keranjang dinonaktifkan.
        </div>
                        ...
                        <div class="card product-card position-relative">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center gap-2 mt-auto">
                                    <a href="lihat_detail.php?id=<?= $product['id'] ?>" class="btn-primary-custom w-100 text-decoration-none text-center">
                                        <i class="bi bi-eye fs-5 me-2"></i> Lihat Produk
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        <?php else: ?>
            <div class="text-center py-5 mt-4">
                ...
                <a href="<?= strtok($_SERVER["REQUEST_URI"], '?') ?>" class="btn-outline-custom mt-3 px-4 fw-bold">Reset Pencarian</a>
            </div>
        <?php endif; ?>
    </div>

...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($error)) {
        ...
        if (json_last_error() !== JSON_ERROR_NONE || empty($decoded)) {
            ...
            mysqli_stmt_bind_param($stmt, "ssiiisss", $nama_barang, $kategori, $harga_min, $harga_max, $stok_total, $deskripsi, $gambar, $varian_json);
...
<body>
    ...
    <script>
        ...
        function createVariantRow() {
            ...
            row.innerHTML = `
                <input type="number" class="form-control v-ram" placeholder="8" required min="1">
                <input type="number" class="form-control v-rom" placeholder="256" required min="1">
                <input type="number" class="form-control v-harga" placeholder="5000000" required min="1000">
                <input type="number" class="form-control v-stok" placeholder="10" required min="0">
